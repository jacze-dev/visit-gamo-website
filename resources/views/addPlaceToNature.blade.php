...
@endif
        ...
        <form action="{{route('addPlaceToNuture.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
   
    <div>
        <label for="hotels">destination's Name:</label>
        <input type="text" name="name" id="hotels">
    </div>
    ...
    <div>
        ...
        <input type="text" name="description" id="detail">
    </div>
   

    <div>
        <label for="links">Location:</label>
        <input type="text" name="location" id="links">
    </div>
